...
// Savier Osman
// 12/05/2022
// Modified program by adding the phone and number validation functions 
...
class Validate {
    ...
    // Added new class method to test for valid numbers
    public function number($name, $value, $required = true) {
        ...
        //Check field for valid mumeric value and set or clear error message
        if (!is_numeric($value)){
