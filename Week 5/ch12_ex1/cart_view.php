<!-- Savier Osman
11/28/2022
Modified the program add the session end and delete cookie link, and shows the session ID. -->
...
<body>
    ...
    <main>
        ...
        <!-- Adds the session end and delete cookie link, and shows the session ID -->
