...
// Savier Osman
// 11/28/2022
// Updated program to change cookie expireation to 3 years
// and added function to clear and delte session cookie/

// Start session management with a persistent cookie
// $lifetime = 60 * 60 * 24 * 14;    // 2 weeks in seconds
// $lifetime = 0; // Set cookie for just the current session
$lifetime = 60 * 60 * 24 * 365 * 3; // Set cookie for 3 years
...
switch($action) {
    ...
    case 'end_session':
        ...
        $name = session_name();                // Get name od the session cookie
