...
// Savier Osman
// 11/07/2022
// Modified program to use for loop to valid scores, calculate totals and converted while loop to for loop.
...
switch ($action) {
    case 'process_scores':
        ...
        // validate the scores
        // For loop to test values in scores array. Break out of case branch if invalid data
        $is_valid = true;
